...
<html lang="en">
  ...
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    <a class="navbar-brand brand-logo me-5" href="index.html"><img src="{{  asset('app_assets/images/logo.svg') }}" class="me-2" alt="logo" /></a>
    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{  asset('app_assets/images/logo-mini.svg') }}" alt="logo" /></a>
  </div>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card tale-bg">
                  <div class="card-people mt-auto">
                    <img src="{{  asset('app_assets/images/dashboard/people.svg') }}" alt="people">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                      <li>
                        <div class="d-flex">
                          <img src="{{  asset('app_assets/images/faces/face1.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{  asset('app_assets/images/faces/face2.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{  asset('app_assets/images/faces/face3.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{  asset('app_assets/images/faces/face4.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{  asset('app_assets/images/faces/face5.jpg') }}" alt="user">
                          <div>
